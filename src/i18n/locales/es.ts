export const es = {
  ...
  home: {
    ...
    sections: {
      ...
      seasonalAriaLabel: 'Semana Santa',
      seasonalEyebrow: 'TEMPORADA',
      seasonalTitle: 'SEMANA SANTA',
      seasonalCtaLabel: 'Ver todas las procesiones',
      seasonalFrameTag: 'PROCESIONES',
      seasonalStatusToday: 'HOY',
      seasonalStatusNext: 'PRÓXIMO DÍA',
      seasonalStatusPast: 'FINALIZADO',
      seasonalStatusSoon: 'PRÓXIMAMENTE',
