...
export const en: Translations = {
  ...
  home: {
    ...
    sections: {
      ...
      seasonalAriaLabel: 'Holy Week',
      seasonalEyebrow: 'SEASONAL',
      seasonalTitle: 'HOLY WEEK',
      seasonalCtaLabel: 'View all processions',
      seasonalFrameTag: 'PROCESSIONS',
      seasonalStatusToday: 'TODAY',
      seasonalStatusNext: 'NEXT DAY',
      seasonalStatusPast: 'COMPLETED',
      seasonalStatusSoon: 'UPCOMING',
