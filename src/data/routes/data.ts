...
export const routes: Route[] = [
  ...
  // ——————————————————————————————————————————
  {
    ...
    featured: true,
    image: '/images/routes/tapeo.avif',
    longDescription: {
  ...
  },
  {
    ...
    featured: false,
    image: '/images/routes/vermut-albaicin.avif',
    longDescription: {
  ...
  // ——————————————————————————————————————————
  {
    ...
    featured: true,
    image: '/images/routes/miradores.avif',
    longDescription: {
  ...
  },
  {
    ...
    featured: true,
    image: '/images/routes/monumental.avif',
    longDescription: {
  ...
  },
  {
    ...
    featured: true,
    image: '/images/routes/realejo.avif',
    longDescription: {
  ...
  },
  {
    ...
    featured: false,
    image: '/images/routes/reyes-catolicos.avif',
    longDescription: {
  ...
  },
  {
    ...
    featured: true,
    image: '/images/routes/flamenco.avif',
    longDescription: {
  ...
  },
  {
    ...
    featured: false,
    image: '/images/routes/foto-sacromonte.avif',
    longDescription: {
  ...
  // ——————————————————————————————————————————
  {
    ...
    featured: false,
    image: '/images/routes/rio-darro.avif',
    whatToBring: {
  ...
  },
  {
    ...
    featured: true,
    image: '/images/routes/bosque-alhambra.avif',
    whatToBring: {
  ...
  // ——————————————————————————————————————————
  {
    ...
    featured: true,
    image: '/images/routes/artesanos.avif',
    longDescription: {
  ...
  },
  {
    ...
    featured: false,
    image: '/images/routes/esparto-realejo.avif',
    longDescription: {
  ...
  // ——————————————————————————————————————————
  {
    ...
    featured: true,
    image: '/images/routes/sacromonte-flamenco.avif',
    startingPoint: {
...
<p>Two and a half hours, under two and a half kilometres, and no paid entry required. The Arab history of Granada can be read by walking, if you know where to look.</p>`,
    ...
    featured: false,
    image: '/images/routes/granada-arabe.avif',
    startingPoint: {
