...
export const routes: Route[] = [
  ...
  },
  {
    ...
    featured: true,
    image: 'https://upload.wikimedia.org/wikipedia/commons/0/00/Realejo-San_Matias%2C_Granada%2C_Spain_-_panoramio_-_georama_%289%29.jpg',
    longDescription: {
  ...
  },
  {
    ...
    featured: false,
    image: 'https://upload.wikimedia.org/wikipedia/commons/f/f0/Corral_del_Carbon_de_Granada_01.jpg',
    longDescription: {
  ...
  },
  {
    ...
    featured: true,
    image: 'https://upload.wikimedia.org/wikipedia/commons/a/a3/Granada_Spain_Tablao-flamenca-Albaic%C3%ADn-01.jpg',
    longDescription: {
  ...
  },
  {
    ...
    featured: false,
    image: 'https://upload.wikimedia.org/wikipedia/commons/f/f0/Aa_view_from_sacromonte_2016_at_granada_in_spain.jpg',
    longDescription: {
  ...
  // ——————————————————————————————————————————
  {
    ...
    featured: true,
    image: 'https://upload.wikimedia.org/wikipedia/commons/a/ad/Alcaiceria_de_Granada_%281%29.jpg',
    longDescription: {
  ...
  },
  {
    ...
    featured: false,
    image: 'https://upload.wikimedia.org/wikipedia/commons/2/28/Fachada_del_Museo_Casa_de_los_Tiros.jpg',
    longDescription: {
  ...
  // ——————————————————————————————————————————
  {
    ...
    featured: true,
    image: 'https://upload.wikimedia.org/wikipedia/commons/c/c6/Caves_of_Sacromonte_%2846464490595%29.jpg',
    startingPoint: {
