...
export const mixedRoutes: MixedRoute[] = [
  ...
  // ——————————————————————————————————————————
  {
    ...
    duration: '2h',
    title: {
      es: 'Granada en 2 horas: ruta esencial',
      en: 'Granada in 2 Hours: Essential Route',
    },
    description: {
      es: 'Paseo express desde Plaza Nueva hasta el Albaicín bajo, con Carrera del Darro, San Nicolás si tienes piernas y una parada de tapas bien colocada.',
      en: 'Express walk from Plaza Nueva to lower Albaicin, with Carrera del Darro, San Nicolas if your legs allow it and a well-placed tapas stop.',
    },
    totalHours: 2,
  ...
  // ——————————————————————————————————————————
  {
    ...
    duration: '6h',
    title: {
      es: 'Granada en 6 horas: Albaicín y centro',
      en: 'Granada in 6 Hours: Albaicin and Centre',
    },
    description: {
      es: 'Media jornada realista con Albaicín temprano, Catedral y Capilla Real por fuera o por dentro, tapeo en Navas/Realejo y un cierre corto de arte urbano.',
      en: 'A realistic half-day with early Albaicin, Cathedral and Royal Chapel inside or outside, tapas around Navas/Realejo and a short street-art finish.',
    },
    totalHours: 6,
  ...
  // ——————————————————————————————————————————
  {
    ...
    duration: '12h',
    title: {
      es: 'Granada en 12 horas sin Alhambra',
      en: '12 Hours in Granada Without Alhambra',
    },
    description: {
      es: 'Un día completo sin Palacios Nazaríes: monumentos andalusíes, Albaicín, Realejo, Corral del Carbón, tapeo local y atardecer sin convertirlo en una carrera.',
      en: 'A full day without the Nasrid Palaces: Andalusian monuments, Albaicin, Realejo, Corral del Carbon, local tapas and sunset without turning it into a race.',
    },
    totalHours: 12,
  ...
  // ——————————————————————————————————————————
  {
    ...
    duration: '1day',
    title: {
      es: 'Granada en 1 día con Alhambra',
      en: 'Granada in 1 Day with Alhambra',
    },
    description: {
      es: 'Itinerario de jornada completa para quien ya tiene entrada: Alhambra, Bosque, centro histórico, tapeo y mirador con tiempos realistas entre barrios.',
      en: 'Full-day itinerary for visitors with tickets: Alhambra, forest, historic centre, tapas and viewpoint with realistic timing between areas.',
    },
    totalHours: 14,
  ...
  // ——————————————————————————————————————————
  {
    ...
    duration: '2days',
    title: {
      es: 'Granada en 2 días: barrios y Alhambra',
      en: 'Granada in 2 Days: Districts and Alhambra',
    },
    description: {
      es: 'Dos días equilibrados: Alhambra y centro el primer día; Albaicín, Sacromonte, mercados y tapeo más local el segundo. Sin meterlo todo a presión.',
      en: 'Two balanced days: Alhambra and centre on day one; Albaicin, Sacromonte, markets and more local tapas on day two. No overpacking.',
    },
    totalHours: 28,
    neighborhoods: ['alhambra', 'centro', 'realejo', 'albaicin', 'sacromonte'],
    bestFor: {
  ...
  // ——————————————————————————————————————————
  {
    ...
    duration: '3days',
    title: {
      es: 'Granada en 3 días: ciudad y escapada',
      en: 'Granada in 3 Days: City and Day Trip',
    },
    description: {
      es: 'Tres días para combinar lo imprescindible con una escapada cercana: Alhambra, barrios históricos, Sacromonte, tapeo, miradores y margen para Sierra Nevada o Alpujarra.',
      en: 'Three days combining essentials with a nearby escape: Alhambra, historic districts, Sacromonte, tapas, viewpoints and room for Sierra Nevada or the Alpujarra.',
    },
    totalHours: 42,
